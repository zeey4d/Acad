...
$campaign_id = $db->query
  ("INSERT INTO campaigns (category_id, partner_id, campaign_request_id, name, short_description, full_description, 
  cost, state, start_at, end_at, photo)
  VALUES (:category_id, :partner_id, :campaign_request_id, :name, :short_description, :full_description, 
  :cost, :state ,now(), :end_at, :photo)",
  [
