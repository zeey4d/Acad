...
try {
    ...
    $reciver_email = $config['phpmailer']['mail_form_receiver'];
    // Email headers
    $mail->setFrom($fromemail, "mohammedmogeab");
    $mail->addAddress($reciver_email); // Recipient email
    ...
    <head>
        <style>
            ...
            .email-header img { max-width: 150px; height: 100px; width: 100px; border-radius: 50%; margin-bottom: 10px; }
