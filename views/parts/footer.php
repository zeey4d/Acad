...
<!-- <h1>footer</h1> -->
     <div class="main_foter">
        ...
        <div class="who_are_we">
            <h1>من نحن؟</h1><hr>
            <p>بادر. منصة رقمية تهدف الي ربط المتبرعين 
        ...
        <div class="contact_us">
            <h1>تواصل معنا</h1><hr>
            <p>.إذا واجهتك مشكله أو لديك استفسار لا تتردد في التواصل معنا</p>
            <h3>:ارسال الاشعارات</h3><hr>
            <div class="send_notifications">
                <form  action="" method="" enctype="multipart/form-data">
                    ...
                    <input class="content_notice" id="content_notice" type="text" name="content_notice" placeholder="محتوي الاشعار"><br>
        ...
        <div class="certificates_and_ratings">
            ...
            <div class="spread_the_word">
                <form form action="" method="" enctype="multipart/form-data">
                    ...
                    <input id="news_content" class="news_content" type="text" placeholder="محتوي الخبر"><br>
